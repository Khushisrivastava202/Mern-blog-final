...
export default function SignIn() {
  ...
  return (
    <div className='min-h-screen mt-36 m-10'>
      <div className='flex p-3 max-w-4xl mx-auto flex-col md:flex-row md:items-center gap-14'>
        {/* left */}
        <div className="flex-1">
      <Link to="/">
      <Button outline gradientDuoTone="purpleToBlue" size="xl">TechTraverse</Button>
</Link>
 <h4 className="text-3xl font-bold mb-4 mt-4">Welcome Back to My Blog Project</h4>
